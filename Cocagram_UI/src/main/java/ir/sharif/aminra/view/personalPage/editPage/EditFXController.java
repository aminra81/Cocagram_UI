...
public class EditFXController extends FXController implements Initializable {
    ...
    @FXML
    public void edit() {
        editPageListener.eventOccurred(new EditPageEvent(this, firstnameField.getText(),
                lastnameField.getText(), bioField.getText(), birthdateField.getValue(),
                emailField.getText(), phoneNumberField.getText(), avatar));
    }
